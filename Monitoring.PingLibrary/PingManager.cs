...
namespace Monitoring.PingLibrary
{
    ...
    {
        string GetPingDevicesDetailsUrl, UpdateDeviceStatusUrl, GetAppSettingsUrl = string.Empty;
        ...
        string deviceFolderName = "OtherDevices";
        public PingManager()
        {
            ...
            GetPingDevicesDetailsUrl = baseUrl + ConfigurationManager.AppSettings["GetPingDevicesDetailsUrl"].ToString();
        ...
        {
            HttpManager objhttpManager = new HttpManager();
            objPingDeviceDetails = await objhttpManager.GetRequest<List<PingDeviceDetails>>(GetPingDevicesDetailsUrl);
        }
